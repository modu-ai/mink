...
| SPEC-GOOSE-REFLECT-001 | M3 | Task self-critique loop + daily reflection |
| SPEC-GOOSE-CONTEXT-001 | M7 | PAI 11 identity files 관리 (mission/goals/projects/beliefs/models/strategies/narratives/learned/challenges/ideas + growth) |
...
| M3 | Core Workflow | COMMAND, CLI, TUI, Plan-Run-Sync engine, REFLECT-001 |
