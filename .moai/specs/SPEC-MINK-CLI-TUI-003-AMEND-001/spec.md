...
- **REQ-CTA-021 [P2, OPT]**: Where shell completion is requested (`mink completion bash|zsh|fish`), the service **shall** generate a completion script covering all CLI subcommands (audit D5 fix)
