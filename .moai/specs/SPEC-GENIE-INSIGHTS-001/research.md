# SPEC-GENIE-INSIGHTS-001 — Research & Porting Analysis
...
**입력**: `~/.genie/trajectories/failed/*.jsonl`의 `TrajectoryMetadata.FailureReason`
...
func newTrajectory(sessionID, model string, tokens int, ts time.Time) *trajectory.Trajectory {
    return &trajectory.Trajectory{
        ...
        Conversations: []trajectory.TrajectoryEntry{
            {From: "system", Value: "You are Genie."},
...
$ genie insights --last 30 --json > report.json
```
