...
- **Status**: 🟡 draft — Phase 1A + 1B + 1C (paths + keyring) + 1E + 1F + 1D 완료 (backend 100%), Phase 2 / 3 / 4 잔여
...
- **Implementation commits**: 7 (Phase 1A PR #200 / Phase 1B PR #201 / Phase 1C-paths PR #202 / Phase 1C-keyring PR #203 / Phase 1E PR #204 / Phase 1F PR #205 / Phase 1D PR #206)
