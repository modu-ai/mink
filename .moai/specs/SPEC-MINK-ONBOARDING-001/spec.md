...
| 0.2.0 | 2026-04-25 | (선행 SPEC) SPEC-GOOSE-ARCH-REDESIGN-v0.2 Amendment 전파. 스코프를 Desktop Tauri 8-step → CLI(`goose init`) + Web UI 설치 마법사로 축소. REQ-OB-013/REQ-OB-018 [DEPRECATED v0.2] 표시. 5개 미커버 REQ 에 대응하는 AC 신설(AC-OB-017~020). | manager-spec |
