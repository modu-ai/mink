...
**Phase 1** (5/5 ✅): CREDPOOL-001 · ROUTER-001 · RATELIMIT-001 · PROMPT-CACHE-001 · ADAPTER-001 ✅ (2026-04-27 M0~M5 완료, AC-001~012 전수 GREEN)
...
### PARTIAL/IN PROGRESS 19건 — 부분 구현, 추가 작업 필요

CLI-001(TUI 보강), AGENT-001, LLM-001, QMD-001, CREDENTIAL-PROXY-001, FS-ACCESS-001, SECURITY-SANDBOX-001, SIGNING-001, BRIDGE-001, CALENDAR-001, FORTUNE-001, CROSSPLAT-001, ONBOARDING-001, CMDCTX-CLI-INTEG-001, CMDCTX-DAEMON-INTEG-001, CMDCTX-HOTRELOAD-001, CMDCTX-PERMISSIVE-ALIAS-001, CMDCTX-TELEMETRY-001, PLANMODE-CMD-001

(메타 정정 2026-04-30: ADAPTER-001 / ALIAS-CONFIG-001은 실제 완료된 상태로 PARTIAL 목록에서 제외. 추가 개선은 ADAPTER-001-AMEND-001 / ALIAS-CONFIG-001-AMEND-001로 분리.)

### 진행 진단

- **Foundation 완성도**: M0~M2 완료 (16/16 SPEC ✅) — ADAPTER-001 완료 인식 후 갱신
...
- **차단 요소**: OBS-METRICS-001 미존재 (CMDCTX-TELEMETRY 블록) — ALIAS-CONFIG-001은 완료되어 HOTRELOAD-001 블록 해소됨
