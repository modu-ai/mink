# SPEC-GENIE-SUBAGENT-001 — Research & Porting Analysis

> **목적**: Claude Code의 `runAgent()` 3단계 생명주기 + 3-isolation + 3-memory scope + role profile override → GENIE Go 포팅 계약. `.moai/project/research/claude-primitives.md` §4를 본 SPEC REQ와 1:1 매핑한다.
> **작성일**: 2026-04-21
...
→ **REQ-SA-002, REQ-SA-003, REQ-SA-012, REQ-SA-017**. GENIE 포팅:
...
3. **Worktree branch naming**: `genie/agent/{slug}` 제안. 기존 사용자 branch와 충돌 가능 → 접두사 설정 가능화.
