# SPEC-GENIE-TOOLS-001 — Research & Inheritance Analysis
...
- 기존 `SPEC-GENIE-AGENT-001` (DEPRECATED)에 일부 tool 아이디어 스케치 있음 — 폐기 대상이므로 참고만.
...
### 2.4 기존 SPEC-GENIE-QUERY-001 (소비자 계약)
...
import "github.com/genieagent/genie/internal/tools/builtin"
...
GREEN 완료 시점에서 **QUERY-001 AC-QUERY-002/003/007/009/010/017의 integration test가 실제 tool 실행으로 통과**하며, `genie ask "read foo.txt"` → `FileRead` 호출 → 응답의 end-to-end가 성립.
