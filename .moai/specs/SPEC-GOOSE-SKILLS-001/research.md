# SPEC-GOOSE-SKILLS-001 — Research & Porting Analysis

> **목적**: Claude Code의 Skill 시스템(TypeScript 원문) → GOOSE Go 포팅 계약을 명확히 한다. `.moai/project/research/claude-primitives.md` §2의 설계를 본 SPEC REQ와 1:1 매핑한다.
> **작성일**: 2026-04-21
