# SPEC-GENIE-CREDPOOL-001 — Research
...
- **Q3**: `permanent exhausted` 해제는 `Pool.Reset(id)`만. CLI 명령(`genie pool reset <id>`)은 CLI-001 범위.

---

**End of Research (SPEC-GENIE-CREDPOOL-001)**
