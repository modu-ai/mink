# SPEC-GENIE-IDENTITY-001 research.md — Identity Graph 구현 자료
...
│   ├── context.go         // urn:genie:identity:v1 vocabulary
│   └── export_test.go
└── contract/
...
{
  "@context": {
    "@vocab": "urn:genie:identity:v1#",
    "name": "http://xmlns.com/foaf/0.1/name",
    "validFrom": "urn:genie:identity:v1#validFrom",
    "validUntil": "urn:genie:identity:v1#validUntil"
  },
  "@graph": [
    {
      "@id": "urn:genie:entity:user-goos",
      "@type": "Person",
      "name": "Goos",
      "aliases": ["행님"],
      "WORKS_AT": {
        "@id": "urn:genie:entity:org-samsung",
...
$ genie identity export --format=jsonld --out=me.jsonld
Exported 14 entities, 27 facts to me.jsonld

$ genie identity snapshot ~/.genie/snapshots/2026-04-21.kuzu
