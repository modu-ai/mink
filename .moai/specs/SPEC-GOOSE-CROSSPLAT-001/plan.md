...
# Implementation Plan — SPEC-GOOSE-CROSSPLAT-001
...
2. `.github/workflows/release.yml` 작성
   ...
   - goreleaser 실행
   - 설치 스크립트 CDN 업로드
3. Homebrew tap 저장소 생성 (`ai-goose/homebrew-tap`)
...
**목표**: `curl -fsSL https://goose.ai/install | sh` 작동
...
**목표**: `irm https://goose.ai/install.ps1 | iex` 작동
...
manifests/
  a/ai-goose/goose/       # winget manifest templates
```
