# SPEC-GOOSE-PLUGIN-001 — Research & Porting Analysis

> **목적**: Claude Code의 `manifest.json` 기반 plugin host + MCPB 번들 → GOOSE Go 포팅 계약. `.moai/project/research/claude-primitives.md` §6을 본 SPEC REQ와 1:1 매핑한다.
> **작성일**: 2026-04-21
...
**Validator**:
- `TestValidator_ReservedName_{goose,claude,mcp,_prefix}` (4 case)
