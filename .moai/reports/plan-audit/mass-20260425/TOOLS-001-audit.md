...
- [N/A] MP-4 Section 22 language neutrality
  - Evidence: This SPEC is scoped to `internal/tools/` (Go implementation for MINK). spec.md:L238–273 (package layout) and §6.8 (dependencies: Go 1.22+, doublestar, jsonschema/v6) are unambiguously single-language. MP-4 criterion does not apply.
