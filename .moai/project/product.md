...
| v4.0 | GOOSE (거위) | 자기진화 100% 개인화 | 글로벌 오픈소스 | Apache 2.0, Linux Foundation |
| v5.0 | GOOSE (거위 + 다마고치) | 사용자가 키우는 AI 동반자 | 글로벌 오픈소스 | Apache 2.0, Linux Foundation |
| **v6.0** | **GOOSE (Daily Companion)** | **매일 아침·점심·저녁 돌봐주는 AI** | **글로벌 오픈소스** | **Apache 2.0, Linux Foundation** |
...
- **라이선스:** **Apache-2.0** (모든 코어 + 생태계)
- **저장소:** github.com/modu-ai/goose
...
- 라이브러리 사용 OK
- 특허 grant 포함 (contributor의 명시적 patent license)
- NOTICE 파일 보존 의무
...
- Apache License 2.0 (누구나 사용/수정 가능, 특허 grant 포함)
...
| 라이선스 | MIT(코어) + 상업 | 100% Apache-2.0 | 100% Apache-2.0 | 100% Apache-2.0 |
...
**작성자:** MoAI 팀  
**기밀도:** Public (오픈소스)  
**라이선스:** Apache-2.0 (이 문서도 포함)

**GitHub:** github.com/modu-ai/goose  
