...
var _ iface.Provider = (*deepseek.Client)(nil)

func TestNew_HappyPath(t *testing.T) {
	t.Parallel()
	c, err := deepseek.New("sk-deepseek-test", deepseek.ClientOptions{})
	if err != nil {
...
func TestNew_EmptyKey(t *testing.T) {
	t.Parallel()
	_, err := deepseek.New("", deepseek.ClientOptions{})
...
func TestClient_Name(t *testing.T) {
	t.Parallel()
	c, _ := deepseek.New("sk-deepseek-test", deepseek.ClientOptions{})
	if c.Name() != "deepseek" {
...
func TestClient_Capabilities(t *testing.T) {
	...
	if cap.SupportsVision {
		t.Error("SupportsVision should be false for DeepSeek")
	}
