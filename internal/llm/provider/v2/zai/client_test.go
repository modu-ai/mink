...
var _ iface.Provider = (*zai.Client)(nil)

func TestNew_HappyPath(t *testing.T) {
	t.Parallel()
	c, err := zai.New("glm-api-key-test", zai.ClientOptions{})
	if err != nil {
...
func TestNew_EmptyKey(t *testing.T) {
	t.Parallel()
	_, err := zai.New("", zai.ClientOptions{})
...
func TestClient_Name(t *testing.T) {
	t.Parallel()
	c, _ := zai.New("glm-api-key-test", zai.ClientOptions{})
	if c.Name() != "zai" {
		t.Errorf("Name() = %q, want zai", c.Name())
	}
}
...
func TestClient_Capabilities(t *testing.T) {
	...
	want := []string{"glm-5-turbo", "glm-4-plus"}
